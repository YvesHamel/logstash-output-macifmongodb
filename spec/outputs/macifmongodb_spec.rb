...
require "logstash/outputs/macifmongodb"
require "logstash/codecs/plain"
require "logstash/event"

describe LogStash::Outputs::Macifmongodb do
  ...
  it "should register" do
    plugin = LogStash::Plugin.lookup("output", "macifmongodb").new(config)
    expect {plugin.register}.to_not raise_error
  end

  describe "#send" do

    subject! { LogStash::Outputs::Macifmongodb.new(config) }
